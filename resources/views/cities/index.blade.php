        ...
        <div class="col">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('cities.create') }}" class="float-right btn btn-primary"><i class="fa fa-plus"></i> Create</a>
                </div>
            </div>
                <div class="card-body">
                    <table class="table">
                            ...
                            @if($cities->count())
                                ...
                                <tr>
                                    ...
                                    <td class="text-align-center">
                                        <a href="{{ route('cities.edit', $city->id) }}" class="btn btn-success"> <i class="fa fa-edit"></i> Edit</a>
